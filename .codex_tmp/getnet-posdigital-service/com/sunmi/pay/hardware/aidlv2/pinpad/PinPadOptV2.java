...
public interface PinPadOptV2 extends android.os.IInterface
{
  ...
  public static class Default implements com.sunmi.pay.hardware.aidlv2.pinpad.PinPadOptV2
  {
    ...
    /**
         ...
         * pinPadType: 密码键盘类型(类型：int，0-预置密码键盘(由服务实现样式统一的键盘,默认值) ，1-客户端自定义的密码键盘)
    ...
    /**
         ...
         * timeoutGap1: 手指触摸屏幕时间，单位：ms(类型：int)
         * timeoutGap2：两次点击屏幕的间隔时间，单位：ms(类型：int)
         * ttsLanguage：语音播报的语言(类型：int，0-跟随系统（默认值），1-英语，2-波兰语，3-法语)
         * @return 0-成功，<0-错误码
         */
