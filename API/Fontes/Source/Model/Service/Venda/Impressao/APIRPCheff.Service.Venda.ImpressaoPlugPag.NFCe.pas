unit APIRPCheff.Service.Venda.ImpressaoPlugPag.NFCe;
...
type
  TAPIRPCheffServiceVendaImpressaPlugPagNFCe = class(TAPIRPCheffServiceVendaImpressao)
  private
...
{ TAPIRPCheffServiceVendaImpressaPlugPagNFCe }

function TAPIRPCheffServiceVendaImpressaPlugPagNFCe.Execute: TStream;
var
  LCupom64: string;
  LJSON: TJSONObject;
...
function TAPIRPCheffServiceVendaImpressaPlugPagNFCe.GetCupom: string;
var
