unit APIRPCheff.Service.Venda.ImpressaoCielo;
...
uses
  ...
  type
  TAPIRPCheffServiceVendaImpressaoCielo = class(TAPIRPCheffServiceVendaImpressao)
  private
    FData                    : TDateTime;
...
{ TAPIRPCheffServiceVendaImpressaoCielo }

procedure TAPIRPCheffServiceVendaImpressaoCielo.AddText(const AContent, AAlign, ASize: string;
  const AStyle: string);
var
  LObj: TJSONObject;
begin
...
procedure TAPIRPCheffServiceVendaImpressaoCielo.AddBlankLine;
begin
  AddText(' ', 'center', 'small');
end;

procedure TAPIRPCheffServiceVendaImpressaoCielo.AddSeparator;
var
  LObj: TJSONObject;
begin
  LObj := TJSONObject.Create;
...
procedure TAPIRPCheffServiceVendaImpressaoCielo.AddDash;
var
  LObj: TJSONObject;
begin
  LObj := TJSONObject.Create;
...
procedure TAPIRPCheffServiceVendaImpressaoCielo.CarregarEmpresa;
begin
  FreeAndNil(FEmpresa);
...
procedure TAPIRPCheffServiceVendaImpressaoCielo.CarregarGarcons;
var
...
procedure TAPIRPCheffServiceVendaImpressaoCielo.CarregarItemFracionado;
var
...
procedure TAPIRPCheffServiceVendaImpressaoCielo.CarregarItemNormal(AItem: TAPIRPCheffEntityVendaItem);
var
...
procedure TAPIRPCheffServiceVendaImpressaoCielo.CarregarItens;
begin
...
procedure TAPIRPCheffServiceVendaImpressaoCielo.CarregarOpcionais(AItem: TAPIRPCheffEntityVendaItem);
begin
  if not FImprimirOpcionais then
    Exit;
...
procedure TAPIRPCheffServiceVendaImpressaoCielo.CarregarPagamentos;
var
...
procedure TAPIRPCheffServiceVendaImpressaoCielo.CarregarPagamentosAntecipados;
var
...
procedure TAPIRPCheffServiceVendaImpressaoCielo.CarregarRodape;
begin
  AddBlankLine;
  AddSeparator;
  AddBlankLine;
...
procedure TAPIRPCheffServiceVendaImpressaoCielo.CarregarTotal;
var
...
begin
  ...
  AddBlankLine;
  AddDash;
  AddText('Sub total: ' + FormatarMoeda(LTotalItens), 'left', 'medium', 'bold');
...
procedure TAPIRPCheffServiceVendaImpressaoCielo.CarregarVenda;
var
...
begin
  ...
  try
    ...
    AddBlankLine;
    AddText(Trim(LDescricaoVenda + ' CUP. ' + FVenda.numeroCupom.ToString), 'center', 'medium', 'bold');
    AddText('CONF. SIMPLES', 'center', 'medium', 'bold');
    AddDash;
...
destructor TAPIRPCheffServiceVendaImpressaoCielo.Destroy;
begin
  FreeAndNil(FVenda);
  FreeAndNil(FEmpresa);
  FreeAndNil(FVendaItens);
...
procedure TAPIRPCheffServiceVendaImpressaoCielo.CarregarOperadorPreFechamento;
var
...
function TAPIRPCheffServiceVendaImpressaoCielo.Execute: TStream;
begin
  FData := Now;
