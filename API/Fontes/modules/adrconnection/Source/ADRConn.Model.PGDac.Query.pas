...
function TADRConnModelPgDACQuery.ParamAsLargeInt(AIndex: Integer; AName: string; AValue: Largeint;
  ANullIfEmpty: Boolean): IADRQuery;
begin
  Result := Self;
...
function TADRConnModelPgDACQuery.ParamAsLargeInt(AName: string; AValue: Largeint;
  ANullIfEmpty: Boolean): IADRQuery;
begin
  Result := Self;
