...
function TADRConnModelFiredacQuery.ParamAsLargeInt(AIndex: Integer; AName: string;
...
function TADRConnModelFiredacQuery.ParamAsLargeInt(AName: string; AValue: Largeint;
  ANullIfEmpty: Boolean): IADRQuery;
begin
  Result := Self;
